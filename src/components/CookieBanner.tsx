...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-calcuu-detail shadow-lg p-4 md:p-6">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 max-w-6xl">
        <p className="text-sm text-calcuu-text-sub text-center sm:text-left">
          ...
          <a href="/privacy" className="text-calcuu-primary underline hover:no-underline">
            privacybeleid
          </a>
          .
        </p>
